...
const t2_Scores = document.getElementById("score-team2");
const t2_Wicket = document.getElementById("wickets-team2");
...
.textContent = t1Score;
  ...
  t2_Scores.textContent = t2Score;
  t2_Wicket.textContent = t2Wicket;
}
